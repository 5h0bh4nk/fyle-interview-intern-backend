...
class Assignment(db.Model):
    ...
    def grade_assignment(cls, _id, grade, principal: Principal):
        assignment = Assignment.get_by_id(_id)
        assertions.assert_found(assignment, 'No assignment with this id was found')
        assertions.assert_valid(assignment.teacher_id == principal.teacher_id, 'This assignment is assigned to other teacher')
        ...
        if not GradeEnum.is_valid_grade(grade):
            raise ValidationError(message='This grade is invallid')
